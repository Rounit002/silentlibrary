...
import { Home, UserPlus, Building2, Calendar, Clock, Grid, DollarSign, Wallet, ShoppingBag, BarChart2, Settings, ChevronRight, UserCheck, AlertTriangle, Menu, X, LogOut, MapPin, Package, ToggleLeft, CreditCard, Users } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    ...
    { path: '/staff-payments', icon: <Users size={20} />, label: 'Staff Payment' },
