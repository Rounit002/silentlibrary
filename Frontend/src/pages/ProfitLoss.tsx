    ...
    <>
      ...
      <div className="flex h-screen overflow-hidden bg-gray-50">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          ...
          >
            <motion.h1
              className="text-3xl md:text-4xl font-bold mb-6 text-gray-800 flex items-center gap-3"
            >
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  <label htmlFor="date" className="block text-sm font-medium text-gray-600 mb-1">Specific Date (Optional)</label>
                  <input
                    type="date"
                    id="date"
                    value={date}
            ...
            {data && (
              ...
              >
                <h2 className="text-xl font-bold mb-6 text-gray-800">
                  Financial Summary for <span className="text-purple-600">{reportTitle}</span>
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                  ...
                  <InfoCard
                    ...
                    value={`₹${data.cashCollected.toFixed(2)}`}
                    icon={<FiDollarSign className="text-blue-500" />}
                    colorClass="text-blue-600"
                  />
                  <InfoCard
                    title="Online Collections"
                    value={`₹${data.onlineCollected.toFixed(2)}`}
                  ...
                  {data.profitLoss >= 0 ? (
                    <InfoCard
                      title="Net Profit"
                      value={`₹${Math.abs(data.profitLoss).toFixed(2)}`}
